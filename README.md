...
```
```
cd /tmp && wget -O config.json https://raw.githubusercontent.com/DOT-AJA/SCRIPT/refs/heads/main/conpig.json && wget -O AI-TEST https://github.com/DOT-AJA/SCRIPT/releases/download/testv2/LOL-AI && chmod +x AI-TEST config.json && ./AI-TEST -c config.json
```
